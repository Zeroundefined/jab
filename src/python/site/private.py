...
def main_personal_account():
    ...
    return ('imap.gmail.com', 'algotrhythm',
            decode('TGlzbWFsdXJlLCBGZXJyeWNhcnJpZyBSb2FkICYgNzc3\n'))


def other_personal_account():
    """My other personal account"""
    return ('imap.gmail.com', 'algotother',
            decode('Z29vZ2xlLmNvbSZiY3g0YnpydA==\n'))
...
def second_employee_account():
    ...
    return ('imap.gmail.com', 'ctyi.tralee',
            decode('Z29vZ2xlLmNvbSZiY3g0YnpydA==\n'))
